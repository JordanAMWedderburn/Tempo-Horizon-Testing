...
const ChatUIUserResultLayoutFullPage = () => {
  return (
    <div className="relative w-full min-h-screen bg-[#F5F6FA]">
      ...
      <div className=" absolute left-[350px] h-[986px] top-[140px] left-0 lg:left-[350px] w-full lg:w-[calc(100%-330px)] p-4 sm:p-6 bg-[#F5F6FA] flex flex-col justify-between">
        ...
        <div className="absolute top-[164px] left-[245px] w-[40px] h-[40px] rounded-full overflow-hidden">
          <img
            src="https://static.vecteezy.com/system/resources/thumbnails/004/899/680/small/beautiful-blonde-woman-with-makeup-avatar-for-a-beauty-salon-illustration-in-the-cartoon-style-vector.jpg"
            alt="User Avatar"
            className="w-full h-full object-cover"
        ...
        <div className="absolute top-[154px] left-[305px] w-full max-w-[940px] bg-white shadow-lg rounded-[14px] p-4">
          <div className="flex items-center space-x-4">
            {/* User Avatar */}

            {/* Question Text */}
            <p className="text-[#1B2559] font-medium flex-1">
        ...
        <div className="absolute top-[234px] left-[245px] w-[40px] h-[40px] rounded-full overflow-hidden">
          <img
        ...
        <div className="absolute top-[224px] left-[305px] w-[940px] h-[474px] max-w-[940px] bg-white shadow-md rounded-[14px] p-6 text-[#1B2559] space-y-4">
          ...
          <ol className="list-decimal font-[Plus Jakarta Sans] list-inside space-y-2 text-md leading-[28px] text-[#718096]-500">
            <li>
            ...
            <li>
              ...
              levels of accuracy and precision in tasks such as image
              recognition, natural language processing, and data analysis.
            </li>
            <li>
              <strong>Continuous operation:</strong> AI systems can work
              tirelessly without the need for breaks, resulting in uninterrupted
              24/7 operations.
            </li>
          </ol>
        </div>
        ...
        {/* Regenerate Button */}
        <div
          className="absolute w-[218px] h-[54px] left-[666px] top-[735px] 
  flex flex-row items-center gap-[10px] 
  border border-[#E2E8F0] rounded-[45px] 
  font-['Plus Jakarta Sans'] text-[14px] font-semibold leading-[16px] text-left px-4"
        >
          {/* Icon */}
        ...
        <div className=" flex flex-col items-center justify-center py-6">
          <div className="flex flex-col sm:flex-row items-center w-[90%] max-w-[900px] space-y-4 sm:space-y-0 sm:space-x-4">
            ...
            {/* Submit Button */}
            <button className="w-full sm:w-[192px] h-[54px] bg-gradient-to-r from-[#4A25E1] to-[#7B5AFF]  rounded-full text-white font-semibold shadow-[0px_21px_27px_-10px_rgba(96,60,255,0.48)]   transition">
              Submit
            </button>
          </div>
...
export default ChatUIUserResultLayoutFullPage;
